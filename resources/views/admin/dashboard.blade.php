        ...
        <div class="relative z-10 flex items-center justify-between">
            <div class="flex-1">
                <div class="flex items-center gap-2 mb-2">
                    ...
                    <span class="text-white/70 text-sm font-medium">Sistem Online</span>
                </div>
                <h1 class="text-3xl font-bold mb-2">Selamat Datang, Admin!</h1>
                <p class="text-white/70 text-lg">Berikut adalah ringkasan statistik domain desa hari ini.</p>
